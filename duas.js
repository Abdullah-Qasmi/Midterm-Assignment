...
const duas = [
...

    {
        ...
        urdu: "کہہ دو: میں لوگوں کے رب کی پناہ لیتا ہوں۔",
        reference: "Qur'an 114:1"
    },

    {
        ...
        english: "Our Lord, grant us from our spouses and offspring comfort to our eyes and make us an example for the righteous.",
        urdu: "اے ہمارے رب! ہمیں ہماری بیویوں اور اولاد کی طرف سے آنکھوں کی ٹھنڈک عطا فرما اور ہمیں پرہیزگاروں کا امام بنا۔",
...

    {
        ...
        urdu: "اے ہمارے رب! ہمیں اور ہمارے ان بھائیوں کو بخش دے جو ایمان میں ہم سے پہلے گزر گئے۔",
...

    {
        ...
        urdu: "اے میرے رب! مجھے توفیق دے کہ میں تیری اس نعمت کا شکر ادا کروں جو تو نے مجھ پر فرمائی۔",
...

    {
        ...
        arabic: "وَأَصْلِحْ لِي فِي ذُرِّيَّتِي",
        transliteration: "Wa aslih li fi dhurriyyati.",
        english: "And make righteous for me my offspring.",
        urdu: "اور میری اولاد کو میرے لیے نیک بنا دے۔",
...

    {
        ...
        urdu: "اے میرے رب! اپنے پاس جنت میں میرے لیے ایک گھر بنا دے۔",
...

    {
        ...
        urdu: "اور اے میرے رب! میں اس بات سے تیری پناہ مانگتا ہوں کہ وہ میرے پاس آئیں۔",
        reference: "Qur'an 23:98"
    },

    {
        id: 20,
        title: "Dua for a Blessed Place",
        ...
        urdu: "اے میرے رب! مجھے برکت والی جگہ اتار اور تو سب سے بہتر جگہ دینے والا ہے۔",
...

    {
        ...
        english: "Our Lord, grant us mercy from Yourself and guide us to the right course in our affair.",
        urdu: "اے ہمارے رب! ہمیں اپنے پاس سے رحمت عطا فرما اور ہمارے معاملے میں ہمارے لیے درست راستہ آسان فرما۔",
...

    {
        ...
        urdu: "مجھے تکلیف پہنچی ہے اور تو سب سے بڑھ کر رحم کرنے والا ہے۔",
...

    {
        ...
        urdu: "مجھے مسلمان ہونے کی حالت میں موت دے اور مجھے نیک لوگوں کے ساتھ ملا دے۔",
...

    {
        ...
        urdu: "اے میرے رب! مجھے، میرے والدین کو اور تمام مومنوں کو اس دن بخش دے جب حساب قائم ہوگا۔",
...

    {
        ...
        urdu: "اے میرے رب! مجھے ایسے نیک اعمال کرنے کی توفیق دے جن سے تو راضی ہو۔",
        reference: "Qur'an 27:19"
    },

    {
        ...
        urdu: "اے میرے رب! مجھے حکمت عطا فرما اور مجھے نیک لوگوں کے ساتھ شامل فرما۔",
...
function createDuaCard(dua) {
    ...
    article.innerHTML = `
        ...
        <div class="flex-1 flex flex-col gap-4">
            ...
            <h2 class="text-xl font-bold text-[#0f5132]">
            ...
            <div class="bg-[#f7f8f3] rounded-xl p-5">

                <p
                    dir="rtl"
                    class="font-serif text-2xl leading-loose
                           text-[#0f5132] text-right">
            ...
            <p class="text-sm text-[#68776e] italic">
